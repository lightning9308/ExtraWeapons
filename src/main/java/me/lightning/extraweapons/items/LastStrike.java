...
public class LastStrike extends CustomItem {
    ...
    public ItemStack createItem() {
        return new ItemBuilder(Material.IRON_SWORD)
                .itemName(Component.text("Last Strike")
                        .color(TextColor.color(125,60,255))
                ...
                Component.text("§7Deals more damage the lower your health is"),
                Component.text("§7+100% (25% HP), +50% (50% HP)"))
                .build();
    }
